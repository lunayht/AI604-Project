"""
    Code adapted from
        - https://github.com/lukemelas/PyTorch-Pretrained-ViT/tree/master/pytorch_pretrained_vit
        - https://github.com/lukemelas/simple-bert
"""
import numpy as np
import torch
...
def as_tuple(x: Union[Tuple, int]):
